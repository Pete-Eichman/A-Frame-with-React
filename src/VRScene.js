  ...
  render () {
    return (
      <Scene>
        ...
        <Entity geometry={{primitive: 'torus', arc: '360', radius:'.5', radiusTubular:'0.05'}} material="color: #000000" position={[0, 4.5, -4]} rotation={[-90, 0, 0]}/>
        <Entity geometry={{primitive: 'torus', arc: '360', radius:'.25', radiusTubular:'0.025'}} material="color: #000000" position={[0, 5, -4]} rotation={[-90, 0, 0]}/>
        <Entity geometry={{primitive: 'torus', arc: '360', radius:'.125', radiusTubular:'0.0125'}} material="color: #000000" position={[0, 5.25, -4]} rotation={[-90, 0, 0]}/>
        <Entity geometry={{primitive: 'torus', arc: '360', radius:'.0625', radiusTubular:'0.00625'}} material="color: #000000" position={[0, 5.5, -4]} rotation={[-90, 0, 0]}/>
        ...
        <Entity geometry={{primitive: 'ring', radiusInner:'.05', radiusOuter:'.1'}} position={[0, .55, -3.49]} material={{shader: 'flat', color: '#ffffff'}}/>
